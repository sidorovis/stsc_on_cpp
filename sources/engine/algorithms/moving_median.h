#ifndef _STSC_ENGINE_ALGORITHMS_DETAILS_MOVING_MEDIAN_H_
#define _STSC_ENGINE_ALGORITHMS_DETAILS_MOVING_MEDIAN_H_
	...
	namespace engine
	{
		namespace algorithms
		{
			namespace details
			{
				...
				class moving_median
				{
					friend class stsc::tests_::engine::algorithms::details_moving_median_tests;
...
#endif // _STSC_ENGINE_ALGORITHMS_DETAILS_MOVING_MEDIAN_H_
