...
namespace stsc
{
	namespace engine
	{
		namespace algorithms_storage
		{
			...
			protected:
				explicit on_period_algorithm( const details::algorithm_init& init, typed_serie_ptr& serie );
			...
			template< typename output_signal_type >
			on_period_algorithm< output_signal_type >::on_period_algorithm( const details::algorithm_init& init, typed_serie_ptr& serie )
