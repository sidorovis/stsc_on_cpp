			...
			namespace algorithms_storage
			{
				void on_period_algorithm_tests()
				{
					...
					using namespace stsc::engine;
 					...
 					create_algorithm< on_period_test_algorithm >( "period_test_algo" );

					typed_algorithm< on_period_test_algorithm > algo = algorithm_storage().create_on_period< on_period_test_algorithm >( "period_test_algo" );
